...
def inference(images):
  ...
  with tf.variable_scope('conv1') as scope:
    kernel = _variable_with_weight_decay('weights',
                                        ...
                                        wd=0.0)
    bind_num = 2
    conv = maxout_cnn_layer(conv0, kernel, bind_num, [1, 1, 1, 1], padding='SAME', name=None)
           #conv = tf.nn.conv2d(images, kernel, [1, 1, 1, 1], padding='SAME')
  ...
  with tf.variable_scope('conv2') as scope:
    kernel = _variable_with_weight_decay('weights',
                                        ...
                                        wd=0.0)
    bind_num = 2
    conv = maxout_cnn_layer(conv2a, kernel, bind_num, [1, 1, 1, 1], padding='SAME', name=None)
    biases = _variable_on_cpu('biases', [192], tf.constant_initializer(0.0))
    pre_activation = tf.nn.bias_add(conv, biases)
